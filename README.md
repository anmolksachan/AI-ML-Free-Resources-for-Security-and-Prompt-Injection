...
- [OrcaPromptVault — system prompt archive](https://github.com/Continuum-AI-Corp/OrcaPromptVault) — 110 system prompts and tool schemas from 35 shipping AI products; 35 of them recorded off the wire by a local proxy, each with the command that reproduces it, so a prompt you extracted can be diffed against a reference instead of trusted
